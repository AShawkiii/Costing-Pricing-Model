...
import { SYSTEM } from '@shell/modules';
    ...
    <div className="print-sheet">
      <header className="print-sheet__header">
        <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
          ...
          <div>
            <div className="print-sheet__system">{SYSTEM.name} · Costing &amp; Pricing</div>
      ...
      <footer className="print-footer">
        <span>{SYSTEM.name} · Costing &amp; Pricing — {product.name || 'Untitled product'}</span>
