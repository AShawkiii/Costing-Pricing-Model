...
/** Namespaced per system and module, so other modules can store alongside. */
const STORAGE_KEY = 'finance-support:costing-pricing:v1';
/** Key used before Costing & Pricing became a Finance Support module. */
const LEGACY_STORAGE_KEY = 'costing-pricing-model:v1';
